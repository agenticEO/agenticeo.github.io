        ...
        <section id="about" className="space-y-8 scroll-mt-24 relative pb-12">
          <div className="space-y-4">
            ...
            <div className="text-slate-700 leading-relaxed space-y-5 font-light text-lg text-justify">
              <p>
                Recent breakthroughs in foundation models, multimodal large language models (MLLMs), reinforcement learning (RL), and AI agents are rapidly transforming artificial intelligence from passive perception systems into reasoning- and action-oriented agents capable of planning, tool use, and sequential decision-making. At the same time, Earth observation (EO) is entering a new era driven by unprecedented volumes of multimodal geospatial data, including satellite imagery, SAR, hyperspectral observations, LiDAR, climate simulations, and large-scale geospatial knowledge bases. These developments create a timely opportunity to rethink EO not merely as an image understanding problem, but as a domain for building intelligent agents that can perceive, reason, interact, and make decisions within complex Earth systems.
              </p>
              <p>
                Despite rapid progress in geospatial foundation models and remote sensing MLLMs, most existing EO research remains centered on static perception tasks such as classification, segmentation, captioning, and detection. However, many real-world environmental and societal applications—including disaster response, climate adaptation, environmental monitoring, autonomous sensing, urban planning, and scientific discovery—fundamentally require adaptive reasoning, active information acquisition, long-horizon planning, uncertainty-aware decision-making, and iterative interaction with external tools and simulators. Simultaneously, recent advances in agentic AI, reinforcement fine-tuning (RFT), world models, and tool-augmented reasoning are beginning to enable AI systems that can autonomously gather evidence, invoke geospatial tools, coordinate multiple observations, and perform grounded multi-step reasoning in dynamic environments.
              </p>
              <p>
                This workshop is motivated by the convergence of these two rapidly evolving frontiers: (1) the emergence of agentic and reasoning-centric AI systems, and (2) the growing need for intelligent Earth observation systems capable of supporting real-world environmental decision-making. We believe this moment is uniquely important for establishing a dedicated research forum that bridges machine learning, computer vision, reinforcement learning, geospatial AI, and Earth sciences. Without such coordination, research efforts risk becoming fragmented across disconnected communities, slowing progress toward general-purpose geospatial AI agents capable of addressing pressing global challenges in climate, sustainability, and disaster resilience.
              </p>
              <p>
                The workshop will provide a dedicated venue for discussing these challenges and exploring future directions for agentic AI in Earth observation. Through invited talks, panel discussions, poster sessions, and oral presentations, the workshop will foster interdisciplinary collaboration between AI researchers and Earth scientists.
              </p>
            </div>
          </div>
